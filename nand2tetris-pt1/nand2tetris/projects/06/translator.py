...
class Translator(Tokenizer):
    def __init__(self,file):
        ...
        # self.labels(self.instuctionList)
        # self.identifyInst(self.instuctionList[0])
        # self.aInstruction('@32767')
        # self.cInstruction('0;JMP')
        # self.cInstruction('D=M')
        # self.cInstruction('D=D-M;JMP')
        # self.cInstruction('D = D-M ; JMP')
        # self.cInstruction('MD=D+1')
        # self.variables(self.instuctionList)
        print("_____________")
...
translated = Translator("Max.asm")    
# translated.identifyInst('@2')
